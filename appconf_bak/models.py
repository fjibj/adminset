...
class Project(models.Model):
    ...
    jmx_port = models.CharField(u"JMX服务端口", max_length=255, null=False, blank=False,default='1')
    ...
    app_console_url = models.CharField(u"控制台URL", max_length=255, null=True, blank=True)
